...
def social(request):
	fig4 = plot(px.histogram(df, x='social_support_std', nbins=20, animation_frame='year'), output_type='div')
...
def health(request):
	fig4 = plot(px.histogram(df, x='health_std', nbins=20, animation_frame='year'), output_type='div')
...
def gdp(request):
	fig4 = plot(px.histogram(df, x='gdp_std', nbins=20, animation_frame='year'), output_type='div')
	...
	fig1 = plot(px.bar(df03, x="gdp_std", y="country", animation_frame="year", color="country", orientation="h"),
				output_type='div')
