...
* Boxplot
  ...
  fig.show()
  ```
<img src="https://github.com/rcm2000/BigdataService_team1/blob/master/md-images/box_social.gif" alt="image-20210726023933273" style="zoom:50%;" />
...
1. Theme2 info
   ...
   * Correlation plot
     ...
     plt.show()
     ```
<img src="https://github.com/rcm2000/BigdataService_team1/blob/master/md-images/heatmap_title2.gif" alt="image-20210726023933273" style="zoom:50%;" />
...
2. Covid-19
   ...
   * Area chart
     ...
     fig.show()
     ```
<img src="https://github.com/rcm2000/BigdataService_team1/blob/master/md-images/area_covid_monthly.gif" alt="image-20210726023933273" style="zoom:50%;" />
     * 월별 확진자수 추이(나라별, 6개국)
   ...
   * Area chart
     ...
     fig.show()
     ```
<img src="https://github.com/rcm2000/BigdataService_team1/blob/master/md-images/area_monthly_death.gif" alt="image-20210726023933273" style="zoom:50%;" />
     * 월별 사망자수 추이(나라별, 6개국)
